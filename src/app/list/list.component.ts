...
export class ListComponent implements OnInit {
    ...
    constructor(private router: Router, private storage: StorageService, private hash: HashService, private titleService: TitleService, private metaService: Meta) { }

    ngOnInit(): void {
        this.titleService.setTitle('List View');
        this.metaService.updateTag({ name: 'description', content: 'A list of all villains currently operating in the Lower Mainland that are to be defeated by the Night Crusade Titans.' });
